...
public class CustomDialog extends AppCompatActivity {
    ...
    public CustomDialog(Context context, ArrayList<Baihat> baihatArrayList, int position, Dialog view) {
    ...
    public void setData(){
        ...
        Picasso.with(context).load(baihatArrayList.get(position).getHinhbaihat()).into(imghinh);

        String path = Environment.getExternalStorageDirectory().getAbsolutePath() + "/Download";
        String tenbh = (path+"/"+baihatArrayList.get(position).getTenbaihat()+".mp3");
        int idbh = Integer.parseInt(baihatArrayList.get(position).getIdbaihat());
    ...
    public void eventClick() {
        viewshare.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("sharecakhuc",baihatArrayList.get(position));
            ...
            public void onClick(View v) {
                ...
                if(DangNhapActivity.statuslongin ==1){
                    ...
                    if (check % 2 != 0) {
                        ...
                        Call<String> callback = dataservice.UpdateLuotThich("1", baihatArrayList.get(position).getIdbaihat());
                        callback.enqueue(new Callback<String>() {
                            ...
                            public void onResponse(Call<String> call, Response<String> response) {
                                ...
                                if (ketqua.equals("Success")) {
                                    ...
                                    db.UpdateUser_BaiHat(DangNhapActivity.username,Integer.parseInt(baihatArrayList.get(position).getIdbaihat()),1);
                                } else {
                        ...
                        callback.enqueue(new Callback<String>() {
                            ...
                            public void onResponse(Call<String> call, Response<String> response) {
                                ...
                                if (ketqua.equals("success")) {
                                    ...
                                    db.UpdateUser_BaiHat(DangNhapActivity.username,Integer.parseInt(baihatArrayList.get(position).getIdbaihat()),0);
                                } else {
                    ...
                    builder.setPositiveButton("Đăng nhập", new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int id) {
                            ...
                            intent.putExtra("login",CustomDialog.this.toString());
                            context.startActivity(intent);
                        }
                    });
    ...
    public static void saveBaiHatDatabase() {
        ...
        String path = Environment.getExternalStorageDirectory().getAbsolutePath() + "/Download";
        //them bai hat
        int id = Integer.parseInt(baihatArrayList.get(position).getIdbaihat());
